...
function ForgotPassword() {
  ...
  return (
    <div className='vybe-auth-page w-full h-screen bg-gradient-to-b from-black to-gray-900 flex flex-col justify-center items-center'>
      {/* TOAST NOTIFICATION */}
      {toast.show && (
        <div
      ...
      {/* STEP 1: Enter Email */}
      {step === 1 && (
        <div className='vybe-auth-card w-[90%] max-w-[500px] h-[450px] bg-white text-black rounded-2xl flex justify-center items-center flex-col border-2 border-[#1a1f23] gap-5 p-6'>
      ...
      {/* STEP 3: Reset Password */}
      {step === 3 && (
        <div className='vybe-auth-card w-[90%] max-w-[500px] h-[550px] bg-white text-black rounded-2xl flex justify-center items-center flex-col border-2 border-[#1a1f23] gap-5 p-6'>
